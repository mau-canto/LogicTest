...
//datos de entrada
//años en BC o AC
var a1: Int = -753  //Int.random(in: -753...2021)	//es el valor inferior en el rango de años que se evaluará, el rango máximo va desde el Anno Urbis Conditae que es el 753BC hasta el 2021AC
var a2: Int = -747							//es el valor superiro en el rango de años que se evaluará.
