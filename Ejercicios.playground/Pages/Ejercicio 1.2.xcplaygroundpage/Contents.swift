//Hecho por Mauricio Canto 09/Feb/2021

import Foundation

var T: Int = Int.random(in: 1...10) //Dejar esto solamente inicializado
var N: [Int] = []
var M: [Int] = []
var flecha: [String] = []
...
for i in 0..<T {
	...
	N.append(Int.random(in: 1...10))
	print("N[\(i)] = \(N[i])")
	print("Valor de M = ")
	M.append(Int.random(in: 1...10))
	print("M[\(i)] = \(M[i])\n")
