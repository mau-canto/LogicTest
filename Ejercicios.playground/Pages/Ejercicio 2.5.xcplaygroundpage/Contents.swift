...
var cantidadmax: Int			//para guardar el número de la cantidad de espacios para letras max
...
//Buscar algún valor del rango que posiblemente pueda ser superior a alguno de los límites
